    ...
    public class AddressableGroupDataExporterDrawer : Mu3WindowDrawer
    {
        ...
        public override void OnGUIBody()
        {
            ...
            DrawStruct(() =>
            {
                ...
                GUILayout.Space(4);
                DrawNamespaceField(_scriptNamespace, value => _scriptNamespace = value, "Addressable Exporter: Namespace");
                GUILayout.Space(4);
                DrawClassNameField(_scriptClassName, value => _scriptClassName = value, "Addressable Exporter: Class Name", DefaultClassName);
                GUILayout.Space(8);
                DrawGroupPreview();
                GUILayout.Space(8);
