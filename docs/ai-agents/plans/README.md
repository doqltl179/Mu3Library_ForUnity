...
Use this section when the question is which plan template, storage rule, or plan-writing convention applies.
...
- If plan selection is no longer the question, return to [../README.md](../README.md).
- Keep plan rules in `task-record-policy.md` and template shape in `plan-template.md` instead of repeating them elsewhere.
