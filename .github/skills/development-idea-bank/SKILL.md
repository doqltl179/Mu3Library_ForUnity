...
- Use the linked workflow page for output shape, ranking rules, anti-patterns, and refinement mode.
- Start from repository evidence before using any web research.
- Use web research only after the whitespace map exists and only to widen adjacent patterns.
- Do not turn the skill into execution sequencing, final owner selection, or verification ownership.
