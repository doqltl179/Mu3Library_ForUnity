...
namespace Mu3Library.Editor.Window.Drawer
{
    ...
    public class InputSystemNameExporterDrawer : Mu3WindowDrawer
    {
        ...
        private SerializedObject SerializedSelf
        {
            get
            {
                if (_serializedSelf == null)
                    _serializedSelf = new SerializedObject(this);
                return _serializedSelf;
            }
        }

        private SerializedProperty _propInputActionAsset;
        private SerializedProperty PropInputActionAsset
        {
            get
            {
                if (_propInputActionAsset == null)
                    _propInputActionAsset = SerializedSelf.FindProperty(nameof(_inputActionAsset));
                return _propInputActionAsset;
            }
        }

        private SerializedProperty _propScriptSaveFolder;
        private SerializedProperty PropScriptSaveFolder
        {
            get
            {
                if (_propScriptSaveFolder == null)
                    _propScriptSaveFolder = SerializedSelf.FindProperty(nameof(_scriptSaveFolder));
                return _propScriptSaveFolder;
            }
        }
        ...
        private void DrawInputActionAssetField()
        {
            ...
            EditorGUILayout.PropertyField(PropInputActionAsset, new GUIContent("Input Action Asset"));
        ...
        {
            SerializedSelf.Update();
            EditorGUILayout.PropertyField(PropScriptSaveFolder, new GUIContent("Script Save Folder"));
            if (SerializedSelf.ApplyModifiedProperties() && _scriptSaveFolder != null)
            {
