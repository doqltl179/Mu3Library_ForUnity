...
namespace Mu3Library.Sample.Game
{
    public class MainSceneController : MonoBehaviour
    {
        ...
        private void Start()
        {
            SceneLoader.Instance.AddSceneLoadStartListener(StaticDatas.SCENE_NAME_GAME, TestStart);
            SceneLoader.Instance.AddSceneLoadEndListener(StaticDatas.SCENE_NAME_GAME, TestEnd);
            SceneLoader.Instance.AddSceneLoadProgressListener(StaticDatas.SCENE_NAME_GAME, TestProgress);
        }

        private void OnDestroy()
        {
            SceneLoader.Instance.RemoveSceneLoadStartListener(StaticDatas.SCENE_NAME_GAME, TestStart);
            SceneLoader.Instance.RemoveSceneLoadEndListener(StaticDatas.SCENE_NAME_GAME, TestEnd);
            SceneLoader.Instance.RemoveSceneLoadProgressListener(StaticDatas.SCENE_NAME_GAME, TestProgress);
        }
