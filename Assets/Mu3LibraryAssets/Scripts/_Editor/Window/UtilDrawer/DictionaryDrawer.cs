...
namespace Mu3Library.Editor.Drawer {
        ...
        */
        ...
        private TValue ChangeValueType(Rect rect, TKey key, TValue value) {
            ...
            if(GUI.Button(rect, content, changeItemStyle)) {
                ...
                genericMenu.AddItem(new GUIContent("Numbers/int"), value is int, () => { _Dictionary[key] = (TValue)(object)default(int); });
                genericMenu.AddItem(new GUIContent("Numbers/float"), value is float, () => { _Dictionary[key] = (TValue)(object)default(float); });
                genericMenu.AddItem(new GUIContent("Numbers/double"), value is double, () => { _Dictionary[key] = (TValue)(object)default(double); });
                genericMenu.AddItem(new GUIContent("Numbers/long"), value is long, () => { _Dictionary[key] = (TValue)(object)default(long); });
                genericMenu.AddItem(new GUIContent("Vectors/Vector2"), (value is Vector2 && !(value is Vector2Int)), () => { _Dictionary[key] = (TValue)(object)default(Vector2); });
                genericMenu.AddItem(new GUIContent("Vectors/Vector3"), (value is Vector3 && !(value is Vector3Int)), () => { _Dictionary[key] = (TValue)(object)default(Vector3); });
                genericMenu.AddItem(new GUIContent("Vectors/Vector4"), value is Vector4, () => { _Dictionary[key] = (TValue)(object)default(Vector4); });
                genericMenu.AddItem(new GUIContent("Vectors/Vector2Int"), value is Vector2Int, () => { _Dictionary[key] = (TValue)(object)default(Vector2Int); });
                genericMenu.AddItem(new GUIContent("Vectors/Vector3Int"), value is Vector3Int, () => { _Dictionary[key] = (TValue)(object)default(Vector3Int); });
                genericMenu.AddItem(new GUIContent("Bounds/Bounds"), value is Bounds && value is not BoundsInt, () => { _Dictionary[key] = (TValue)(object)default(Bounds); });
                genericMenu.AddItem(new GUIContent("Bounds/BoundsInt"), value is BoundsInt, () => { _Dictionary[key] = (TValue)(object)default(BoundsInt); });
                genericMenu.AddItem(new GUIContent("Rects/Rect"), value is Rect && value is not RectInt, () => { _Dictionary[key] = (TValue)(object)default(Rect); });
                genericMenu.AddItem(new GUIContent("Rects/RectInt"), value is RectInt, () => { _Dictionary[key] = (TValue)(object)default(RectInt); });
                genericMenu.AddItem(new GUIContent("string"), value is string, () => { _Dictionary[key] = (TValue)(object)""; });
                genericMenu.AddItem(new GUIContent("bool"), value is bool, () => { _Dictionary[key] = (TValue)(object)default(bool); });
                genericMenu.AddItem(new GUIContent("Color"), value is Color, () => { _Dictionary[key] = (TValue)(object)default(Color); });
                genericMenu.AddItem(new GUIContent("AnimationCurve"), value is AnimationCurve, () => { _Dictionary[key] = (TValue)(object)(new AnimationCurve()); });
                genericMenu.AddItem(new GUIContent("Gradient"), value is Gradient, () => { _Dictionary[key] = (TValue)(object)(new Gradient()); });
                genericMenu.AddItem(new GUIContent("Unity Object"), value is UnityObject, () => { _Dictionary[key] = (TValue)(object)(new UnityObject()); });
    ...
    [CustomPropertyDrawer(typeof(SerializableDictionary<Type>))]
    public class SerializableDictionaryDrawer<TKey, TValue> : DictionaryDrawer<TKey, TValue> { }
}